...
public class LogWindow extends JInternalFrame implements LogChangeListener
{
    ...
    // компонент Swing для отображения и редактирования многострочного текста (переменная хранит текстовое поле, в котором ПОКАЗЫВАЮТСЯ сообщения лога)
    private final TextArea m_logContent; 

    public LogWindow(LogWindowSource logSource) // передаем в конструктор источник логов
    {
        super("Протокол работы", true, true, true, true); // вызов конструктора родительского класса
